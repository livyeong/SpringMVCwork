    ...
    <div class="container" style="margin-top: 100px">
      <div class="card shadow">
        ...
        <span class="sr-only">Previous</span>
                ...
                <c:otherwise>
                  <li class="page-item">
                	<a href="${root}board/main?board_info_idx=${board_info_idx}&page=${pageBean.prevPage}" class="page-link">&laquo;</a>
              	  </li>
                </c:otherwise>
              </c:choose>
        ...
        <span class="sr-only">Next</span></a>
                ...
                <c:otherwise>
                  <li class="page-item">
                	<a href="${root}board/main?board_info_idx=${board_info_idx}&page=${pageBean.nextPage}" class="page-link">&raquo;</a>
              	  </li>
                </c:otherwise>
              </c:choose>
